...
//
//	// new
//	connect(m_list_gui->m_action_new, &QAction::triggered, this, &singleLabelList::newNarrative);
//	connect(m_window->ui.plus, &QPushButton::clicked, this, &singleLabelList::newNarrative);
//
//	// delete
//	connect(m_list_gui->m_action_delete, &QAction::triggered, this, &singleLabelList::deleteSelection);
//	connect(m_window->ui.minus, &QPushButton::clicked, this, &singleLabelList::deleteSelection);
//}
//
