...
Widget::Widget(int flags): osg::Geode(), m_position(0.0f, 0.0f), m_size(0.0f, 0.0f), m_alpha(1.0f), m_borderAlpha(1.0f),
        m_alphaMult(1.0f), m_bgGeometry(NULL), m_borderGeometry(NULL),
        m_handler(NULL), m_zoffset(0), m_parentOffset(0.0f, 0.0f), m_anchorHEdge(ANCHOR_L), m_anchorVEdge(ANCHOR_B),
        m_anchorValue(0.0f, 0.0f), m_parent(NULL), m_highlight(false)
{
